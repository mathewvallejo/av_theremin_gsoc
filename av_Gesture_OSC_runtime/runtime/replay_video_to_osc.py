...
from gesture_model_runtime import GestureRuntimeModel, apply_artifact_dir_override
...
def main():
    ...
    if args.model_dir:
        apply_artifact_dir_override(cfg.setdefault("runtime_model", {}), args.model_dir)
