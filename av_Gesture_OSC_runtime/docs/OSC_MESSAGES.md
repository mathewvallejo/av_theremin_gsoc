...
Coordinates follow the active runtime feature contract. New Stage 2 exports use wrist-relative, scale-normalized landmarks for model input. OSC landmark messages use the same vectors that are sent to the model.
