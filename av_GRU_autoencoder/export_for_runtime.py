...
def build_runtime_model_config(cfg):
    ...
    return {
        ...
        "features": {
            ...
            "audio_schema": features.get("audio_schema"),
            ...
            "hand_order": features.get("hand_order", "label"),
            "feature_order": features.get("feature_order", "right_63_left_63"),
            "missing_hand_value": float(features.get("missing_hand_value", 0.0)),
        },
        "model": {
            "motion_dim": int(features.get("motion_dim", 126)),
